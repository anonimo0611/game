...
export class Ghost extends Actor {
	...
	*/
	...
	#goingOut({init,speed,y,center:{x:cx}}=this) {
		...
		this.dir = L
		this.#started ||= true
		this.state.to('Walking')
	}
	#enterHouse() {
		this.dir = D
		this.centering()
		this.state.to('Returning')
	}
	...
	#setPacCaughtState() {
		Sound.stopLoops()
		State.to('PacCaught').to('PacDying', {delay:500})
	}
